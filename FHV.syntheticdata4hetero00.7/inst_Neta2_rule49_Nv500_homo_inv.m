...
ZhyeYinresolutionsteps.Nic=[100,100,10];
...
%%%%%%%%%%%%%%%%%%%%
MultiplierForPixelnoisevarIC_eachstep=[10.0 1.0 1.0];
%%%%%%%%%%%%%%%%%%%%
ii=ii+1;
cmd{ii}.operator='misc_diary';
cmd{ii}.fn_diary='off';
...
for step=1:length(ZhyeYinresolutionsteps.lmax)
  ...
  cmd{ii}.fn_rule='/home/mitchvogel/Documents/research/imaging/Matlab/hetero00.71/rule_small_3_rulechopper';
  %%%%%%%%%%%%%%%%%%%%
  ii=ii+1;
