...
%[path basename ext v]=fileparts(basename); %Unix Matlab returns only 3 parts, 'v' not used, PCD 05 July 2013
[path basename ext]=fileparts(basename); %Unix Matlab returns only 3 parts, 'v' not used, PCD 05 July 2013
