...
% 07/01/2010
%
%modified by pd83 on 08-07-2015 to include the special name
%_set_tilde_b_to_empty_ as a part of adding real-valued spherical
%harmonics angular basis functions.

if strcmp(b_fn,'_set_tilde_b_to_empty_')
  tildeb=[];
  return;
end
