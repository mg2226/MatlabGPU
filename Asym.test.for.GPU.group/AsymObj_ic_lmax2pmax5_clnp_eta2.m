...
vecclnp=100*vecclnp;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fn=['AsymObj.ic.lmax' num2str(lmax) 'pmax' num2str(pmax) '.clnp.eta2.txt'];
fid=fopen(fn,'w');
if fid==-1
  error('cannot open %s\n',fn);
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fn=['AsymObj.ic.lmax' num2str(lmax) 'pmax' num2str(pmax) '.nu.eta2.txt'];
fid=fopen(fn,'w');
if fid==-1
  error('cannot open %s\n',fn);
end
...
fclose(fid);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fn=['AsymObj.ic.lmax' num2str(lmax) 'pmax' num2str(pmax) '.q.eta2.txt'];
fid=fopen(fn,'w');
if fid==-1
  error('cannot open %s\n',fn);
end
...
lmax=0;
pmax=1;
fn=['AsymObj.ic.lmax' num2str(lmax) 'pmax' num2str(pmax) '.clnp.eta2.RealSphHarm.c001iszero.txt'];
fid=fopen(fn,'w');
if fid==-1
  error('cannot open %s\n',fn);
end
