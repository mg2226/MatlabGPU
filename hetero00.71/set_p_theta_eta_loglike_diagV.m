function [p, loglike]=set_p_theta_eta_loglike_diagV(rule, vk, y, noise_var, virusobjs)
%function [p, loglike]=set_p_theta_eta_loglike_diagV(rule, vk, y, noise_var, virusobjs)
...
%fprintf(1, 'This is function set_p_theta_eta_loglike_diagV\n');
...
%     parfor (n=1:1)
        ...
        lndet_Sigma=lndet_fast(noise_var,L,vo{eta}.nu,lndetV);
        %fprintf(1,'elapsed time %d\n',etime(clock,t_p));
...
fprintf(1,'computing the log likelihood...\n');
