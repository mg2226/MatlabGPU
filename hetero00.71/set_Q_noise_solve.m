function noise_var=set_Q_noise_solve(rule, vk, y,virusobjs, p_theta_eta,Na, iter)
%function [Qem gQem HQem]=set_Q_noise(rule, vk, y, noise_var, virusobjs,p_theta_eta)
...
A=A*Na*Na;
noise_var=B/A;
save(strcat('set_Q_noise_solve_test', int2str(iter)));
